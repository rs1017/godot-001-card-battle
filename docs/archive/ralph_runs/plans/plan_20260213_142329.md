...
- CycleId: 3
- ReferenceFocus: docs
- SourceInventory: reference_inventory_20260213_142329.md
...
- Reference image link: images/cycle_3 (image files are managed by grapher output).
...
- Planning data csv: data/plan_20260213_142329.csv
