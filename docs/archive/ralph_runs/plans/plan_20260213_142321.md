...
- SourceInventory: reference_inventory_20260213_142321.md
...
- Reference image link: images/cycle_2 (image files are managed by grapher output).
...
- Planning data csv: data/plan_20260213_142321.csv
