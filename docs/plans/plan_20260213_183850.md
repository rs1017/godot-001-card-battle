...
- SourceInventory: reference_inventory_20260213_183850.md
...
- Reference image link: images/cycle_11 (image files are managed by grapher output).
...
- Planning data csv: data/plan_20260213_183850.csv
