...
- CycleId: 9
- ReferenceFocus: docs
- SourceInventory: reference_inventory_20260213_183655.md
...
- Reference image link: images/cycle_9 (image files are managed by grapher output).
...
- Planning data csv: data/plan_20260213_183655.csv
