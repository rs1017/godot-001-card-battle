...
- CycleId: 8
- ReferenceFocus: docs
- SourceInventory: reference_inventory_20260213_183644.md
...
- Reference image link: images/cycle_8 (image files are managed by grapher output).
...
- Planning data csv: data/plan_20260213_183644.csv
