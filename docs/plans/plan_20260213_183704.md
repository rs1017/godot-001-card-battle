...
- SourceInventory: reference_inventory_20260213_183704.md
...
- Reference image link: images/cycle_10 (image files are managed by grapher output).
...
- Planning data csv: data/plan_20260213_183704.csv
